...
//--------------------------/admin templates/--------------------------/
export const RESET_PASSWORD_ADMIN_TEMPLATE = `
  <!DOCTYPE html>
  <html>
  <head>
    <meta charset="UTF-8" />
            ...
            <tr>
              <td style="padding:30px; color:#333333;">
                ...
                <table cellpadding="0" cellspacing="0" border="0" align="center" style="margin:30px auto;">
                  <tr>
                    <td align="center" bgcolor="#4f46e5" style="border-radius:5px;">
                      <a href="${FRONTEND_URL_ADMIN}/forgot-password"
                         style="display:inline-block; padding:12px 25px; font-size:14px; color:#ffffff; text-decoration:none; border-radius:5px;">
                        Reset Password
                      </a>
                    </td>
...
export const EMAIL_VERIFY_ADMIN_TEMPLATE = `
  <!DOCTYPE html>
  <html>
  <head>
    <meta charset="UTF-8" />
            ...
            <tr>
              <td style="padding:30px; color:#333333;">
                ...
                <table cellpadding="0" cellspacing="0" border="0" align="center" style="margin:30px auto;">
                  <tr>
                    <td align="center" bgcolor="#4f46e5" style="border-radius:5px;">
                      <a href="${FRONTEND_URL_ADMIN}/email-verify-admin"
                         style="display:inline-block; padding:12px 25px; font-size:14px; color:#ffffff; text-decoration:none; border-radius:5px;">
                        Verify Email
                      </a>
                    </td>
...
export const INVITE_ADMIN_TEMPLATE = `
  <!DOCTYPE html>
  <html>
  <head>
    <meta charset="UTF-8" />
    <title>Invitation to become admin</title>
  </head>
  <body style="margin:0; padding:0; background-color:#f4f6f9; font-family:Arial, sans-serif;">
        ...
        <td align="center">
          ...
          <table width="600" cellpadding="0" cellspacing="0" border="0" style="background:#ffffff; border-radius:8px; overflow:hidden;">
            ...
            <tr>
              <td style="padding:30px; color:#333333;">
                <p style="font-size:16px; margin-bottom:20px;">
                  We received a request to invite you to become an admin.
                </p>
                ...
                <table cellpadding="0" cellspacing="0" border="0" align="center" style="margin:30px auto;">
                  <tr>
                    <td align="center" bgcolor="#4f46e5" style="border-radius:5px;">
                      <a href="${FRONTEND_URL_ADMIN}/invitation-admin?id={{invitationId}}"
                         style="display:inline-block; padding:12px 25px; font-size:14px; color:#ffffff; text-decoration:none; border-radius:5px;">
                        Accept Invitation
                      </a>
                    </td>
